...
```
cd existing_repo
git remote add origin https://gitlab.com/cinnamon-hotels-web-scraper/backend.git
git branch -M main
...
* [Set up project integrations](https://gitlab.com/cinnamon-hotels-web-scraper/backend/-/settings/integrations)
